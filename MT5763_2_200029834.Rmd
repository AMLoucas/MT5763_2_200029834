 ...
 **For Question 2** \
  ...
  We will firstly plot our data for our 3 drugs in a box-plot. After we will apply a bootstrap algorithm on the 3 effects data to obtain confidence intervals of where the true mean of hair growth length lies for each drug. \
```
/* MT5763 */
...
```
  We noticed as our box-plot, our confidence intervals have returned the same result. The Luxuriant drug is not more efficient than the 2 already existing drugs, with most efficient drug being Baldbegone. \
