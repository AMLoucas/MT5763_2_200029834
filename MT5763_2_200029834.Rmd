...
indent: true
---
###### GitHub repository is: https://github.com/AMLoucas/MT5763_2_200029834
...
#### For question 1 (Is there an effect of Luxuriant above and beyond the placebo?)
 ...
 When applied our Linear model, we noticed that the assumptions are violated, this means that our p-values may not be valid. For this reason we will apply a randomized test on the hair growth means of each drug. \
...
#### [Q1] Is there an effect of Luxuriant above and beyond the placebo
  From our Box-Plot we can conclude that Luxuriant is more efficient than Placebo and by taking the p-value from the model under consideration we know with certainty that our two means are not equal. \
...
![ ](HISTOGRAMS/Q2-HISTOGRAM(1).png)

![ ](HISTOGRAMS/Q2-HISTOGRAM(2).png)

![ ](HISTOGRAMS/Q2-HISTOGRAM(3).png)
  \
...
<!-- conclusions along with criticisms of the design if any -->
  Our new drug Luxuriant is an improvement from Placebo, but is still not more efficient than the drugs Skinheadnomore and Baldbegone. We have also understood that Age was not significant on how efficient the drug was. For future trials we should consider taking more variables under consideration. Weight loss and iron deficiency also affect hair loss, those variables should be monitored [1]. Additionally, subjects may have weaker hair due to the fact of their family or hormones, family trees and hormone levels should be tracked [2]. Another variable to consider is, if the patient is under any medication or supplements, some of these treatments can cause hair loss [2].
