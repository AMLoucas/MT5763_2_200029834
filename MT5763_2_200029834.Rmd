...
#### For question 1 (Is there an effect of Luxuriant above and beyond the placebo?)
  The columns of interest here are, hair growth of drugs Luxuriant and Placebo. We will fit a linear model using as a response variable Hair growth and as a predictor the drug used. \
 Once we applied our Linear model, we have noticed our assumptions are violated, this means that our p-values are uncertain and may not be valid. For this reason we will apply a randomized test on the hair growth means of each drug, this method does not need to follow any distribution assumptions. \
...
#### For question 2 (is age relevant to any effect?)
